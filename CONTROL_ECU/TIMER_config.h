...
/***********************************************************************************************/
	 ...
	 */
	#define TIMER1_WAVEFORM_GENERATION_MODE		TIMER1_CTC_OCR1A_MODE
	 ...
	 * 2. ENABLE
	 */
	#define TIMER1_CTCA_INTERRUPT			ENABLE
